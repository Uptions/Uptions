...
const SOCIAL_LINKS = [
  {
    ...
    fallback: "https://twitter.com/useuptions",
    icon: twitter,
  },
  {
    platform: "LinkedIn",
    href: "linkedin://company/uptions",
    fallback: "https://www.linkedin.com/company/uptions/",
    icon: Linkedin,
  },
  {
    platform: "Instagram",
    href: "instagram://user?username=useuptions",
    fallback: "https://www.instagram.com/useuptions",
    icon: instagram,
  },
];
...
const Nav = () => {
  ...
  return (
    <div
      className="flex justify-between items-center px-[2em] py-[1em] bg-[#001E62] rounded-full mx-[2em] mt-[4em]"
      ref={dropdownRef}
    >
      <div>
    ...
    <button className="bg-[#007BFF] py-5  px-6 rounded-full h-full text-[17px]">Try out Uptions</button>
        ...
        {isOpen && (
          ...
          >
            <ul className="w-full flex flex-col items-center justify-center gap-[1.5em] py-6">
              ...
              {SOCIAL_LINKS.map(({ platform, href, fallback, icon }) => (
                <Link
                  href={href}
                  key={platform}
                  onClick={(e) => {
                ...
                >
                  <div className="flex items-center gap-[1em] font-space">
                    <h1>{platform}</h1>
                    <Image src={icon} alt={`${platform} logo`} />
                  </div>
                </Link>
              ))}
            </ul>
